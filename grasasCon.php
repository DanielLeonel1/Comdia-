...
include("conexion.php");
  $indice=0;
    $alumno=NULL;
    $conteo="SELECT count(*) as n FROM grasaconp";
    $cont=$conne->query($conteo);
    $row2 = $cont->fetch();
    $total= $row2["n"];//
    $sql="SELECT  * FROM grasaconp WHERE category='1'"; 
    $consulta=$conne->query($sql);
   // echo $sql; 
    while ($row = $consulta->fetch()){
      $verduras[$indice]              =new stdClass;
      $verduras[$indice]->Nombre          =$row["NombreGrac"];
...
<table class="table table-success">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> <img src="img/proteina/<?= $cel->imge;?>" height ="120px" ></img></td>
...
<?php 
  $indice=0;
    ...
    $row2 = $cont->fetch();
    $total= $row2["n"];//
    $sql="SELECT  * FROM grasaconp WHERE category='2'"; 
    $consulta=$conne->query($sql);
   // echo $sql; 
    while ($row = $consulta->fetch()){
      $verduras[$indice]              =new stdClass;
...
<?php 
  $indice=0;
    ...
    $row2 = $cont->fetch();
    $total= $row2["n"];//
    $sql="SELECT  * FROM grasaconp WHERE category='3'"; 
    $consulta=$conne->query($sql);
   // echo $sql; 
    while ($row = $consulta->fetch()){
      $verduras[$indice]              =new stdClass;
