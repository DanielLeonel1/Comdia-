...
include("conexion.php");
  $indice=0;
    $alumno=NULL;
    $conteo="SELECT count(*) as n FROM leguminosas";
    $cont=$conne->query($conteo);
    $row2 = $cont->fetch();
    $total= $row2["n"];//
    $sql="SELECT  * FROM leguminosas WHERE category='1'"; 
    $consulta=$conne->query($sql);
   // echo $sql; 
    while ($row = $consulta->fetch()){
      $verduras[$indice]              =new stdClass;
      $verduras[$indice]->Nombre          =$row["NombreLegu"];
...
<table class="table table-success">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> <img src="img/leguminosas/<?= $cel->imge;?>" height ="100px" width = "100"></img></td>
...
<?php 
  $indice=0;
    ...
    $row2 = $cont->fetch();
    $total= $row2["n"];//
    $sql="SELECT  * FROM leguminosas WHERE category='2'"; 
    $consulta=$conne->query($sql);
   // echo $sql; 
    while ($row = $consulta->fetch()){
      $verduras[$indice]              =new stdClass;
...
<?php 
  $indice=0;
    ...
    $row2 = $cont->fetch();
    $total= $row2["n"];//
    $sql="SELECT  * FROM leguminosas WHERE category='3'"; 
    $consulta=$conne->query($sql);
   // echo $sql; 
    while ($row = $consulta->fetch()){
      $verduras[$indice]              =new stdClass;
